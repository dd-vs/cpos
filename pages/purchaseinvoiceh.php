                            ...
                            <div class="row">
                                <div class="col-md-4 -txt-">
                                  <input type="hidden" id="cash-credit"  name="cash_credit" value="10">
                                    <span id="cash" class="btn btn-primary" >Cash</span>
                                    <span id="credit"  class="btn btn-primary btn-credit"  style="display:none;">Credit</span>
                                </div>
                                <div class="col-md-4 -txt-">
                        ...
                        <table class="table invoice-table">
                            ...
                            <tr class="datainput">
								...
								<td colspan="2" class="no-screen">
									<span id="spanid1">
										<!--new rate -->
										<input type="hidden" class="form-control -txt"  name="rateinputnew" id="rateinputnew" value=""  onkeyup="amtCalc(); taxCalc();" tabindex="6">
									</span>
								</td> 
								<td colspan="2">
									<span id="spanid">
										<input type="number" class="form-control -txt"  name="buyprice" id="rate" value=""  onkeyup="amtCalc(); taxCalc();" tabindex="6">
									</span>
								</td> 
								<td  colspan="2">
								...
								<td colspan="2" class="-txt gAmt" style="display: none;">
									<input type="text"  name="added" id="grossAmt"  placeholder="0.00"  min="0"  step="0.01"  class="form-control -txt " onkeyup="rateCalc(); taxCalc();" tabindex="9">
								</td>
								<td colspan="2" class="-txt pAmt">
									<input type="text"  name="added" id="netAmt"  placeholder="0.00"  min="0"  class="form-control -txt " onkeyup="rateCalc(); taxCalc();" tabindex="9">
								</td>
...
//          } 
      ...
      function rateCalc() {
        ...
        var totTax        =   cgstPercent + sgstPercent;
                ...
                if($("#selecttax").val() == 1) {
                    ...
                    $("#rate").val(round(netAmtCess/Qty,2));
                      $("#rateinputnew").val($("#rate").val());//new rate calculation
                } else if($("#selecttax").val() == 2) {
    ...
    function amtCalc() {
        ...
        if(!isNaN(rate*Qty)) {
            ...
            $("#grossAmt").val(round(rate*Qty,2));
             var result=rate*totTax;
             var result1=rate+result/100;
              $("#rateinputnew").val(result1);//new rate calculation
            }
        }    
    };
      //calculate tax
    function taxCalc() {
        ...
        if(!isNaN(totTax*grossAmt)){
            ...
            if($("#selecttax").val() == 2){
                $("#netAmt").val(round(parseFloat(grossAmt) + parseFloat($("#cgstAmt").text()) + parseFloat($("#sgstAmt").text()) +cess,2));
            }
        }
    };	
