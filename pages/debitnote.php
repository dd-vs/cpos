<?php 
	...
	include("../include/include.php"); 
       ...
       for($j1=0;$j1<$num1;$j1++)
       {
        ...
        $CreditNote="select max(ti_creditnote.cnid)+1 as credit_inv_no from ti_creditnote";
		$cnote=$conn->query($CreditNote);
		$cnoteresult=$cnote->fetch();
	 //  $st="rtr";
navbar_user(17); ?>	
  <div id="test">
      <div class="row"><div class="col-md-8"><h2 style="margin-top:0;">Debit Note</h2></div><div class="col-md-4">
            ...
            <div class="form-container" id="invoice">
               ...
               <form  id="frmenquiry" name="frmenquiry" action="../add/creditnoteadd.php" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-4 print-left">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="retDate"  id="AdmtxtDate" value="" required onblur="changeVal('AdmtxtDate','datePrint')" tabindex="1" />
                                        <div class="form-control print-only" id="datePrint"></div>
                                    </div>
                                </div>
								
                                
                                <div class="col-md-4 n-screen">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <span>Return Invoice</span>
                                        </span>
                                        <input type="number" required name="retInvNo" class="form-control" value="<?php echo $cnoteresult['credit_inv_no']; ?>" id="returnInvNo" onblur="changeVal('returnInvNo','returnInvPrint')"/>
										<div class="form-control print-only" id="returnInvPrint"><?php echo $cnoteresult['credit_inv_no']; ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
									...
									<span class="input-group-addon">
                                       ...
                                       <input type="text" name="customer" id="customer" class="form-control"    onblur="changeVal('customer','customerPrint')" />
                                    ...
                                    <div class="form-control print-only no-screen" id="customerPrint">ASIATEK AUTOMOTIVE SOLUTIONS INDIA PVT.LTD</div>  
                                </div>
                            </div>
                        </div>
                           ...
                           <div class="row">
								<div class="col-md-6 print-left">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="invdate"  id="invoiceDate" value="" required onblur="changeVal('invoiceDate','invdatePrint')" tabindex="1" />
                                        <div class="form-control print-only" id="invdatePrint"></div>
                                    </div>
                                </div>
								<div class="col-md-6 print-right n-screen">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <span>Invoice No </span>
                                        </span>
									    <input type="text" required class="form-control" id="invoiceid" name="invNum" value="" onblur="changeVal('invoiceid','invNoPrint')"/>
										<div class="form-control print-only" id="invNoPrint"></div>
                                    </div>
                                ...
                                <div class="col-md-4 -txt-">
                                    <button class="btn btn-primary" onclick="printInv().print(); pdfMake.createPdf(docSave).download('cnote'+$('#returnInvPrint').text()); clickfun();">Print</button>
                                </div>
                                <div class="col-md-4 -txt- no-screen">
                    ...
                    <div class="no-screen" id="custaddress">	378 1 2nd floor ring road 1st stage opp.Karnataka coir board peenya industrial area </div>
                    <div class="no-screen" id="custphone">08029726671</div>
                    <div class="no-screen" id="custstate">Karnataka</div>
                    <div class="no-screen" id="custstatecode"></div>
                    <div class="no-screen" id="custcity">Bangalore</div>
                    <div  class="no-screen"id="custgstin">29AAOCA7387B1ZA</div>
...
<script>
  ...
  notify("success","Succesfully saved");
	...
	function clickfun(){	
							...
							else{setTimeout(function(){   $('form').unbind('submit').submit();   }, 100); }
                    ...
                    var docDefinition = {
                        ...
                        // [left, top, right, bottom] or [horizontal, vertical] or just a number for equal margins
                          pageMargins: [ 40,90, 40, 80 ],
                           ...
                           content: [
                                         {columns: [
										{width: 75, text: 'DEBIT NOTE # ', fontSize: 9, bold: true, alignment: 'left'},
										{width: 130, text: ' : '+document.getElementById('returnInvPrint').innerHTML, fontSize: 10, alignment: 'left'},
										{width: 130, text: 'DEBIT NOTE', fontSize: 11, bold: true, alignment: 'center'},
										
										{width: 120, text: 'DEBIT NOTE DATE ', fontSize: 9, bold: true, alignment: 'right'},
										{width: 60, text: ' : '+document.getElementById('datePrint').innerHTML, fontSize: 10, alignment: 'left'},
												
								],
                                 margin: [0,5]},       
                                        {columns: [ 
										{width: 95, text: 'AGAINST INVOICE # ',  fontSize: 10, bold: true, alignment: 'left'},
										{width: 110, text: ' : '+document.getElementById('invNoPrint').innerHTML, fontSize: 10, alignment: 'left'},
										{width: 70, text: 'INVOICE DATE', fontSize: 10, bold: true, alignment: 'left'},
										{width: 70, text: ': '+document.getElementById('invdatePrint').innerHTML, fontSize: 10, alignment: 'left'},
