...
$update="SELECT `id`, `allowance_name`, `default_val`, `IsActive` FROM `master_allowance` WHERE master_allowance.id='$proid'";
$x=$conn->query($update);
$x->setfetchmode(PDO::FETCH_ASSOC);
 ...
 while($r=$x->fetch()){
  ...
  <div class="form-container">
           ...
           <div class="pop-up-title nomargin" style="">Edit Allowance</div>
            <div class="row" style="padding:10px;"></div>
           	<form  id="frmenquiry" name="frmenquiry" action="../update/mastereditallow.php" method="post">
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group">
                           ...
                           <input type="text" name="item_name"    id="item_name" value="<?php echo $r['allowance_name'] ?>" class="form-control" minlength="2" tabindex="1" required>
                ...
                <div class="row">
					<div class="col-md-6">
						<div class="input-group">
							...
							<option value="1">Allowance</option></select>
						</div>
					</div>
					<div class="col-md-6">
                        <div class="input-group">
