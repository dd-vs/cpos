<?php 
	...
	include("../include/include.php"); 
		...
		$query="select max(ti_sale_invoice.invoice_id)+1 as inv_no from ti_sale_invoice where ti_sale_invoice.IsHidden=11 and ti_sale_invoice.sale_type=0 and ti_sale_invoice.IsActive=1";
		$s1=$conn->query($query); $res1=$s1->fetch();
		$query1="select max(ti_sale_invoice.invoice_num)+1 as inv_no,max(ti_sale_invoice.invoice_id)+1 as inv_id from ti_sale_invoice where ti_sale_invoice.IsHidden=11 and   ti_sale_invoice.sale_type=1 and ti_sale_invoice.IsActive=1";
		$s12=$conn->query($query1); $rwhole=$s12->fetch();
		$query2="select max(ti_sale_invoice.invoice_num)+1 as inv_no,max(ti_sale_invoice.invoice_id)+1 as inv_id from ti_sale_invoice where ti_sale_invoice.IsHidden=11 and   ti_sale_invoice.sale_type=0 and ti_sale_invoice.IsActive=1";
...
<style>.page-content{background: #F9E6E6;}</style> 
  ...
  <h2 style="margin-top:0;">Sales Invoice</h2>
            <div class="form-container" id="invoice">
               ...
               <form  id="frmenquiry" name="frmenquiry" action="../add/sale_invoiceh.php" method="post">
                    <div class="invoice-head col-md-12">
                        <div class="col-md-6 right-border">
                            ...
                            <input id="setHidden" hidden name="hidden" value="11" />
                            <div class="row">
                                <div class="col-md-12">
    ...
    <div class="pop-up-overlay" id="editpopup">
        ...
        <!---------Invoice head  ---------->
            ...
            while($ss=$set->fetch()){
            ?>
            <div class="no-screen" id="invoice-head">
                <p id="brand-name"><?php echo $ss['c_name'];?></p>
                <p class="address" id="address-line1"><?php echo $ss['address_1']; ?></p>
                <p class="contact"><span class="no-print" > <?php echo $ss['website']; ?> </span>  <span class="" id="address-website" ><?php echo $ss['mailid']; ?></span> </p> <p class="contact" style=""; > <span class="" id="address-phone">Phone: <?php echo $ss['phone']; ?> </span>|&nbsp; <span class="" id="mobilePrint"> Mobile: <?php echo $ss['mobile']; ?></span></p>
                <p class="print-left no-print">CIN :<?php echo $ss['cin']; ?> </p>
				<div class="" id="invoice-head1">
				 <div id="invNum" class="-screen"></div>
...
<div id="invPTableC" class="no-screen">
    <table id="invPTable" class="full-width">
                <thead>
                    <tr style="height: 7mm;">
                        <td style="width: 6mm;">No</td>
                        <td style="width: 35mm;">Product</td>
                        
                        <td style="width: 15mm;" >Rate</td>
                        <td style="width: 8mm;">Qty</td>
                        <td style="width: 10mm;">CGST</td>
                        <td style="width: 10mm;">SGST</td>
                        <td style="width: 20mm;" style="text-align: right">Amountt</td>
                    </tr>
                </thead>
             ...
             <tr style="height: 7mm;">
                        <td></td>
                        <td></td>
                        <td class="-txt boldItalics" style="text-align: right;">TAXABLE AMOUNT</td>
                     
                        <td></td>
                        <td></td>
                        <td></td>
                        
                        <td class="-txt" id= "pTotAmt" style="border-top: 1px solid #000; text-align: right;"></td>
                    </tr>
                    <tr style="height: 7mm;">
                        <td></td>
                        <td></td>
                        <td class="-txt boldItalics" style="text-align: right;">OUTPUT CGST</td>
                   
                        <td></td>
                        <td></td>
                        <td></td>
                       
                        <td class="-txt" id="totCgstPrint" style="text-align: right"></td>
                    </tr>
                    <tr style="height: 7mm;">
                        <td></td>
                        <td></td>
                        <td class="-txt boldItalics" style="text-align: right;">OUTPUT SGST</td>
                        
                        <td></td>
                        <td></td>
                        <td></td>
                       
                        <td class="-txt" id="totSgstPrint" style="text-align: right"></td>
                    </tr>
                    <tr style="height: 7mm;">
                        <td></td>
                        <td></td>
                        <td class="-txt boldItalics" style="text-align: right;">NET AMT</td>
                        
                        <td></td>
                        <td></td>
                        <td></td>
                      
                        <td class="-txt" id="nettAmtPrint1" style="text-align: right"></td>
                    </tr>
                    <tr style="height: 7mm;">
                        <td></td>
                        <td></td>
                        ...
                        <td class="-txt" id="roundoffPrint" style="text-align: right"></td>
                    </tr>
                    <tr style="height: 7mm;">
                        <td></td>
                        <td></td>
                        <td class="-txt boldItalics"></td>
                ...
                <tr style="border-collapse: collapse; border-top: 1px solid black;">
                    ...
                    <td id="pTotSgst" colspan="2" style="text-align: right;">Grand Total</td>
                    <td style="border-collapse: collapse; text-align: right;" id="nettAmtPrint"></td>
...
<script>
  ...
  notify("success","Succesfully saved");
    ...
    //alert(myvar);
          $.ajax({
					url:"../get/post.php?p=getwholeid1",
					method:"post",
					data:{ itemid:id }
				}).done(function(data) {
					//alert(data);
...
$.ajax({
					url:"../get/post.php?p=getretailid1",
					method:"post",
					data:{ itemid:id }
				}).done(function(data) {
					//alert(data);
...
//tax part
					...
					ptRow +='<td style="text-align: ">'+$('#grossamt').val()+'</td>';
					ptRow +='</tr>'
						  ...
						  header: {
							  ...
							  columns: [
								[
									...
									{text: ''+document.getElementById("address-line1").innerHTML, fontSize: 10, alignment: 'center', margin: [ 0, 0]},
									{width: 200,text: ''+document.getElementById('mobilePrint').innerHTML, fontSize: 10, alignment: 'center', margin: [5,0,0,3]},
								
									
									{text: document.getElementById('pGst').innerHTML, fontSize: 10,  italics: true, alignment: 'left', margin: [5,40,5,3]},
									{ canvas: [{ type: 'line', x1: -5, y1: 2, x2: 515, y2: 2, lineWidth: 1.5 }], margin: [0,0,0,10] },
									{columns: [
										{width: 80, text: 'Customer Name', fontSize: 10, bold: true, alignment: 'left'},
										{width: 100, text: ': '+document.getElementById('customerPrint').innerHTML, fontSize: 10, alignment: 'left'},
										{width: 100, text: '', fontSize: 10, bold: true, alignment: 'left'},
										{width: 55, text: 'Invoice No', fontSize: 10, bold: true, alignment: 'left'},
										{width: 100, text: ': '+document.getElementById('invNum').innerHTML, fontSize: 10, alignment: 'left'}
										],
										margin: [0,5]},
									{columns: [
										{width: 80, text: 'Mobile No', fontSize: 10, bold: true, alignment: 'left'},
										{width: 100, text: ': '+document.getElementById('custphone').innerHTML, fontSize: 10, alignment: 'left'},
										{width: 100, text: '', fontSize: 10, bold: true, alignment: 'left'},
										{width: 55, text: 'Date', fontSize: 10, bold: true, alignment: 'left'},
										{width: 100, text: ': '+document.getElementById('datePrint').innerHTML, fontSize: 10, alignment: 'left'}
										],
										margin: [0,5]},
                           ...
                           content: [
                                        ...
                                        { canvas: [{ type: 'line', x1: -5, y1: 2, x2: 515, y2: 2, lineWidth: 1.5 }] },
                                        {text: 'Amount: '+inWords(parseInt($('#nettAmtPrint').text()))+' Rupees only ', fontSize: 10, alignment: 'left', margin: [0,10,0,10]},
										 {columns:[
											 {width: 200, text: 'Customer Signature', fontSize: 10, alignment: 'left'},
											 {width: 200, text: 'For Kmp', fontSize: 10, alignment: 'right'},
