...
$search_keyword = '';
	...
	$sql = 'SELECT * FROM ti_suppllier WHERE name LIKE :keyword and  id>1  ORDER BY id ';
...
<div class="row" style="padding-top:10px;">
    <div class="col-md-3">
        <h2 style="margin-top:0;">Suppliers<span class="add-new-p" onclick="openPopup()" ><i class="fa fa-plus-square" aria-hidden="true"></i><div class="tool-tip p-help">Add New Product</div></span></h2>
    </div>
...
<div class="form-container">
    ...
    foreach($result as $s1){ ?>
         <tr>  
            ...
            <td><?php echo $s1['phone'];?></td>
            <td class="-txt red"><?php echo $s1['sup_balance']; ?></td></div>
            <td>
                 <?php if($s1['IsActive']==1) { ?>
                <a href='../status/supactive.php?status=0&pid=<?php echo $s1['id']; ?>'><input type="hidden" name="pid" value="<?php echo $s1['id']; ?>"><span  id="item_active"><span class="green table-item-toggle"><i class="fa fa-toggle-on" aria-hidden="true"></i></span>Active</span></a>
              <?php } 
            else {?>
                <a href='../status/supactive.php?status=1&pid=<?php echo $s1['id']; ?>'><input type="hidden" name="pid" value="<?php echo $s1['id']; ?>"><span  id="item_nonactive" ><span class="red table-item-toggle"><i class="fa fa-toggle-off" aria-hidden="true"></i></span>Inactive</span></a>
       <?php }?>
            </td>
        </tr>
       <?php $y++; }?>
...
<div class="pop-up-overlay" id="popup">
    ...
    <div class="pop-up-body pro-pop-body">
        <div class="popup-container">
            <div class="pop-up-title nomargin" style="">Add New Supplier</div>
            <div class="row" style="padding:10px;"></div>
            <form class="" id="" action="../add/suppliersave.php" method="post">
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control"name="name"  id="AdmtxtName" value="" placeholder="Supplier Name" minlength="2"  required tabindex="1"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="mobile" id="Adm_txtMob" value="" placeholder="10 digit mobile num" required tabindex="2"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group">
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="cin" id="Adm_txtcin" value="" placeholder="" tabindex="6" />
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="balance"  id="Admtxtbal" value=""  placeholder="Balance" required tabindex="7"/>
                        </div>
                    </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" name="address" id="Adm_txtCatadd" value="address" placeholder="Supplier address" tabindex="8"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="state" id="state" tabindex="9"></select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="cities" id="cities" value="" tabindex="10"></select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" name="notes" id="Adm_txtCatnotes" value="address" placeholder="Supplier notes" tabindex="11"></textarea>
                        </div>
                    </div>
                </div>
...
<script>
  ...
  notify("success","Succesfully saved");
    ...
    function openPopupedit(e,ide) {
		...
		var myvar = ide;
		//alert(myvar);
		 $.post('getsupdetails.php?d=test',{ proid:ide },function(data) {
			$('#modelbody').html(data);
