...
html_head();
navbar_user(3);?>
            <h2 style="margin-top:0;">Purchase Return</h2>
            <div class="form-container">
                <form action="../add/purchase_return_save.php" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="date" name="" id="date" value="" />
                                    </div>
                                </div>
-->
 <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="" id="invvv" value="" disabled/>
                                    </div>
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="" id="customer" value="" placeholder="" disabled/>
                                        <span class="input-group-addon">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="inv_id" id="inv_id" value=""  onblur="check(inv_id);"/>
                                        
                                        <?php 
                                        /*
											$query="SELECT `invoice_id` as k,`invoice_id` as v FROM `ti_purchase_invoice`";
  ...
  notify("success","Succesfully saved");
	...
	$(function () { 
		...
		$("#inv_id").autocomplete({
			...
			source: "../get/search.php?p=getpinv",
		...
		function check(inv_id){
			var v=$('#inv_id').val();
			var myvar = v;
			$.ajax({
			url:"getpurajax.php?p=getitem",
			method:"post",
			 data:{a1:v}
			...
			$.ajax({
		url:"../get/post.php?r=getsupplier",
		method:"post",
		 data:{a1:v}
			...
			$("#invvv").val(res[3]);
			$("#sup_id").val(res[4]);
			if(document.getElementById('sup_id').value==1)
			{
