...
navbar_user(16); ?>	
  <div id="test">
      <div class="row"><div class="col-md-8"><h2 style="margin-top:0;">DeliveryNote</h2></div><div class="col-md-4">
            ...
            <div class="form-container" id="invoice">
                <button onclick="printInv().print(); pdfMake.createPdf(docSave).download('DC'+$('#invNum').text());" class="no-screen">Print</button>
               <form  id="frmenquiry" name="frmenquiry" action="estsave.php" method="post">
                    <div class="invoice-head col-md-12">
                            ...
                            <div class="row">
								...
								<div class="col-md-8 -txt-">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="place" id="place" onblur="changeVal('place','plaPrint')" value="" placeholder="Place of Supply"> 
                                    </div>
									<div class="no-screen" id="plaPrint"></div>
                                </div>
                        ...
                        <div class="col-md-4 right-border">
                            <div class="row">
                                 <! --vehicle number-->
                                <div class="col-md-12 no-print n-screen">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <span>Vehicle num</span>
                                        </span>
                                        <input class="form-control" type="text" name="vehicle_num" id="vehicle" onblur="changeVal('vehicle','vehPrint')" value=""> 
                                    </div>
                                </div>
                                <div class="no-screen" id="vehPrint"></div>
                                <div class="col-md-12 n-screen" id="collect_amt">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <span>MODE OF DELIVERY</span>
                                        </span>
                                        <input class="form-control tableOut"  type="text" name="" id="collect" value="" onblur="changeVal2('collect','collectPrint');" onchange="";/>
                         ...
                         <div class="red -txt no-screen" id="total-amt" >
							...
							<div class="col-md-1 -txt-">
                                    <button class="btn btn-primary" onclick="printInv().print(); pdfMake.createPdf(docSave).download('DC'+$('#invNum').text()); clickfun();">Print</button>
                                </div>
                        <div class="col-md-2">
                    ...
                    var docDefinition = {
                        ...
                        // [left, top, right, bottom] or [horizontal, vertical] or just a number for equal margins
                          pageMargins: [ 40,90, 40, 80 ],
                           ...
                           content: [
                                         {columns: [
											{width: 70, text: 'NO', fontSize: 10, bold: true, alignment: 'left'},
											{width: 120, text: ': DC'+document.getElementById('invNoPrint').innerHTML, fontSize: 10, alignment: 'left'},
										{width: 120, text: 'DELIVERY CHALLAN', fontSize: 10, bold: true, alignment: 'center'},
                                 ...
                                 margin: [0,5]},       
                                        {columns: [ 
											{width: 80, text: 'CHALLAN DATE',  fontSize: 10, bold: true, alignment: 'left'},
			...
			table: {
				...
				body: [
					...
					[{text: [
								...
								{width: 80, text: 'Place of Supply', fontSize: 10, bold: true},
								{width: 150, text: ': '+document.getElementById('plaPrint').innerHTML, fontSize: 10},
									{text: '\n', italics: true},
									{width: 80, text: 'Transportation Mode', fontSize: 10, bold: true},
										{width: 150, text: ': '+document.getElementById('collectPrint').innerHTML, fontSize: 10},
											{text: '\n', italics: true},
											{width: 80, text: '', fontSize: 10, bold: true},
											{text: '\n', italics: true},
										{width: 80, text: 'VEHICLE NUM', fontSize: 10, bold: true},
										{width: 150, text: ': '+document.getElementById('vehPrint').innerHTML, fontSize: 10},
