...
navbar_user(15); ?>	
  <div id="test">
      <div class="row"><div class="col-md-8"><h2 style="margin-top:0;">Credit Note</h2></div><div class="col-md-4">
                           ...
                           <div class="row">
								...
								<div class="col-md-6 print-right n-screen">
                                    <div class="input-group">
									    ...
									    <input type="number" required class="form-control" id="invoiceid" name="invNum" value="" onblur="changeVal('invoiceid','invNoPrint')"/>
                    ...
                    var docDefinition = {
                        ...
                        // [left, top, right, bottom] or [horizontal, vertical] or just a number for equal margins
                          pageMargins: [ 40,90, 40, 80 ],
                           ...
                           content: [
                                         {columns: [
										{width: 75, text: 'CREDIT NOTE # ', fontSize: 9, bold: true, alignment: 'left'},
										{width: 130, text: ' : '+document.getElementById('returnInvPrint').innerHTML, fontSize: 10, alignment: 'left'},
										{width: 130, text: 'CREDIT NOTE', fontSize: 11, bold: true, alignment: 'center'},
										
										{width: 120, text: 'CREDIT NOTE DATE ', fontSize: 9, bold: true, alignment: 'right'},
