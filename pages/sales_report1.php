...
<div class="report-container">
    ...
    <div class="report-head">
        <form class="" id="" action="sales_report1.php" method="post">
            <div class="row">
                <div class="col-md-2">
              ...
              <div class="col-md-2">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="" name="inv_num" value="" placeholder="Search Name" />
    ...
    <div class="report-body">
        <table class="table default-table report-table">
          ...
          if(isset($_POST['searchbydate'])){
				...
				WHERE  ti_sale_invoice.IsHidden=10  and ti_sale_invoice.cash_credit=10 and ti_sale_invoice.sale_date between '$f 00:00:00' and '$t 23:59:59' and ti_sale_item.IsActive=1";
				$s=$conn->query($query);
				...
				left join ti_product on ti_product.id=ti_sale_item.product_id left join ti_transport on ti_transport.invoice_id=ti_sale_invoice.invoice_id 
				 left join master_unit on master_unit.id=ti_product.unit_id
				WHERE ti_sale_invoice.IsHidden=10  and ti_sale_invoice.cash_credit=11 and ti_sale_invoice.sale_date between '$f 00:00:00' and '$t 23:59:59' and ti_sale_item.IsActive=1";
				$s1=$conn->query($query1);
				...
				<?php $j++;	}
							...
							echo "<tr id=\"credit\" class=\"sales box tbl-footer\">
                                            <td colspan=\"2\" align=\"left\">Loads : ".number_format($r32['num'],0,'.','')."</td>
											<td colspan=\"5\" align=\"right\">Total</td>
	...
	$query="SELECT ti_sale_item.*,ti_sale_invoice.*,ti_customer.name,ti_product.name as item_name,master_unit.unit_name FROM `ti_sale_invoice`
	 ...
	 left join ti_product on ti_product.id=ti_sale_item.product_id left join ti_transport on ti_transport.invoice_id=ti_sale_invoice.invoice_id 
	  left join master_unit on master_unit.id=ti_product.unit_id
	 WHERE ti_sale_invoice.IsHidden=10 and ti_customer.name like '%$f%' and ti_sale_item.IsActive=1";
	$s=$conn->query($query);
$result2=$s->fetchAll(PDO::FETCH_ASSOC);
...
//alert(myvar);
'<%Session["temp"] = "' + myvar +'"; %>';
window.location="saleinvoiceedit.php?temp=" + myvar;
}
